...
namespace blazorwasm_calls_MS_graph
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddMicrosoftGraphClient("https://graph.microsoft.com/Files.ReadWrite.AppFolder",
            ...
            builder.Services.AddMsalAuthentication(options =>
            {
                ...
                options.ProviderOptions.Authentication.RedirectUri = "https://localhost:44357/";
